...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def create_source(cls, ctx, search: str, *, loop, download=False, fromloop):
        ...
        return cls(discord.FFmpegPCMAudio(executable="/app/ffmpeg/bin/ffmpeg.exe", source=source), data=data, requester=ctx.author)
    ...
    async def regather_stream(cls, data, *, loop):
        ...
        return cls(discord.FFmpegPCMAudio(executable="/app/ffmpeg/bin/ffmpeg.exe", source=data['url']), data=data, requester=requester)
